...
import { X, Wand2, RefreshCw, ArrowRight, Pencil } from 'lucide-react';
...
export default function PathsPanel({ onClose, onAddToCanvas }: PathsPanelProps) {
  const [mode, setMode] = useState<'generate' | 'draw'>('draw');
      ...
      <div className="w-96 bg-white border-r border-slate-200 shadow-xl flex flex-col z-10">
        <div className="p-4 border-b border-slate-200">
          <div className="flex items-center justify-between mb-3">
            <h2 className="text-lg font-bold text-slate-900">Vector Tools</h2>
        ...
        <div className="flex-1 overflow-auto p-4">
          {mode === 'draw' ? (
            <DrawingCanvas onSavePath={onAddToCanvas} />
          ) : (
            <>
